    ...
    <>
              <header className="bg-red-500 text-white p-4">
                    <div className="container max-w-3xl  flex justify-between">
                        <a href="/"><img src="/image/logo-vermelho.svg" className="w-28 md:w-40"></img></a>

                        {auth?.user?.id && (
                            <div onClick={logout}  className="p-2 cursor-pointer">
                            <Icon name="logout" className="w-8"></Icon>
                            </div>
                        )}
                    </div>    
                </header>
            ...
            <main className="space-y-6">
                <section id="header" className="bg-red-500 text-white">
                    <div className="container space-y-2 max-w-3xl p-4">
                    <a href="/dashboard">
                        <Icon name="back" className="w-10"></Icon>
                    </a>
