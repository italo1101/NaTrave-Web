...
export const Cards = ({ disabled, gameId, homeTeam, awayTeam, homeTeamScore, awayTeamScore, gameTime }) => {
        ...
        return(
            <div className="rounded-xl border border-grey-300 p-4 text-center space-y-4">
                    ...
                    <form className="flex space-x-4 justify-center items-center">
                        ...
                        <img src={`/image/flags/${homeTeam}.png`} />
                        ...
                        <img src={`/image/flags/${awayTeam}.png`} />
